...
export default function LiveSupportWidget() {
  ...
  return (
    <div ref={widgetRef} className={`${pathname === "/" ? "hidden sm:block" : ""} fixed right-4 z-[80] sm:bottom-6 sm:right-6 ${/^\/(seller|vendor)(\/|$)/.test(pathname) ? "bottom-[calc(1rem+env(safe-area-inset-bottom))]" : "bottom-[calc(5rem+env(safe-area-inset-bottom))]"}`}>
      {open && (
