...
const translations = {
  en: {
    ...
    announcementInstantDelivery: "Instant delivery 24/7",
    announcementBulkSavings: "Save more on bulk orders",
    announcementSecurePayments: "Secure payments",
    announcementGlobalProducts: "Global gaming products",
  },
  ru: {
    ...
    announcementInstantDelivery: "Мгновенная доставка 24/7",
    announcementBulkSavings: "Больше выгоды при оптовых заказах",
    announcementSecurePayments: "Безопасные платежи",
    announcementGlobalProducts: "Игровые товары со всего мира",
  },
  th: {
    ...
    announcementInstantDelivery: "จัดส่งทันทีตลอด 24/7",
    announcementBulkSavings: "ประหยัดยิ่งขึ้นเมื่อสั่งซื้อจำนวนมาก",
    announcementSecurePayments: "ชำระเงินอย่างปลอดภัย",
    announcementGlobalProducts: "สินค้าเกมจากทั่วโลก",
  },
} as const;
