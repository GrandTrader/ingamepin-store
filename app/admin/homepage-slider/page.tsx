...
export default async function HomepageSliderPage({
  ...
  const [settings, slides, products] = await Promise.all([
    ...
    admin
      ...
      .select(
        "id, product_id, desktop_image_url, button_url, starts_at, ends_at, sort_order, is_active",
      )
  ...
  if (loadError) {
    throw new Error(`Unable to load homepage slider: ${loadError.message}`);
  }
      ...
      <div className="mx-auto flex min-h-screen max-w-[1700px] flex-col lg:flex-row">
        ...
        <main className="min-w-0 flex-1 p-5 sm:p-8">
          ...
          <p className="mt-2 text-sm text-slate-500">
            Manage desktop promotional images and Buy Now links.
          </p>
