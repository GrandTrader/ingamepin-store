...
export default function ProductOptionsEditor({ initialOptions, productName }: { initialOptions: Option[]; productName: string }) {
  ...
  return <><input type="hidden" name="options" value={JSON.stringify(options)} />
    <div className="grid gap-5 xl:grid-cols-[180px_minmax(0,1fr)_250px]">
      ...
      <section className="min-w-0"><div className="mb-5"><h2 className="text-xl font-black">Denomination options</h2><p className="mt-1 text-sm text-slate-500">Edit the customer-visible options and selling prices.</p></div><div className="overflow-x-auto"><div className="min-w-[630px]">
