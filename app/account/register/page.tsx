      ...
      <div className="mx-auto max-w-xl rounded-3xl border border-slate-200 bg-white p-7 shadow-xl sm:p-10">
        {success ? (
          <section className="text-center">
            ...
            <div className="mt-7 rounded-2xl border border-cyan-200 bg-cyan-50 p-5 text-left text-sm text-slate-700">
              <p className="font-black text-slate-950">Activate your account</p>
              <p className="mt-2 leading-6">
                Open the email from iNgamePIN and click <strong>Verify Email &amp; Activate Account</strong>.
                Check your spam or junk folder if it does not appear in your inbox.
              </p>
            </div>
            <Link
              href="/account"
              className="mt-7 inline-flex w-full items-center justify-center rounded-xl bg-cyan-500 px-5 py-3 font-black text-slate-950 transition hover:bg-cyan-400"
            >
              Continue to Sign In
            </Link>
          </section>
